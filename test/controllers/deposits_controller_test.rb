...
class DepositsControllerTest < ActionController::TestCase
  ...
  test "should create deposit" do
    assert_difference('Deposit.count') do
      post :create, deposit: { amount: @deposit.amount, comments: @deposit.comments, date: @deposit.date, member_id: @deposit.member_id, name: @deposit.name, user_id: @deposit.user_id }
    end
  ...
  test "should update deposit" do
    patch :update, id: @deposit, deposit: { amount: @deposit.amount, comments: @deposit.comments, date: @deposit.date, member_id: @deposit.member_id, name: @deposit.name, user_id: @deposit.user_id }
    assert_redirected_to deposit_path(assigns(:deposit))
  end
